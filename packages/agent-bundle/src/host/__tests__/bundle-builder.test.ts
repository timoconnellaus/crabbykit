...
describe("loadBundleFiles", () => {
  ...
  it("injects the runtime source at every virtual path the resolver checks", async () => {
    ...
    expect(loaded.files["node_modules/@claw-for-cloudflare/agent-bundle/bundle.js"]).toBe(
      "/* INJECTED v3 */",
    );
    const pkg = JSON.parse(
      loaded.files["node_modules/@claw-for-cloudflare/agent-bundle/package.json"]!,
    );
    expect(pkg.exports["./bundle"]).toBe("./bundle.js");
  });
